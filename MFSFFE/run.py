...
from model.MFSFFE import MFSFFE as Network
...
args.add_argument('--dataset', default='PEMSD8', type=str)
...
args.add_argument('--model', default='MFSFFE', type=str)
...
args.add_argument('--n_head', default=config['model']['n_head'], type=int)
args.add_argument('--d_model', default=config['model']['d_model'], type=int)
args.add_argument('--d_ff', default=config['model']['d_ff'], type=int)
args.add_argument('--moving_avg', default=config['model']['moving_avg'], type=int)
args.add_argument('--activation', default=config['model']['activation'], type=str)
args.add_argument('--mem_num', default=config['model']['mem_num'], type=int)
args.add_argument('--mem_dim', default=config['model']['mem_dim'], type=int)
args.add_argument('--dec_embed_model_dim', default=config['model']['dec_embed_model_dim'], type=int)
args.add_argument('--tod_model_dim', default=config['model']['tod_model_dim'], type=int)
args.add_argument('--dow_model_dim', default=config['model']['dow_model_dim'], type=int)
#train
...
for p in model.parameters():
    if p.dim() > 1:
        ...
        nn.init.uniform_(p)
#
# def model_summary(args, model, dataloader):
...
# print(model_summary(args,model, train_loader))
